...
func (p *LinodeProvider) Generate(out *os.File) error {
	...
	for _, record := range records {
		...
		fmt.Fprintf(out, "\t// provider: %s, cidr: %s, region: %s\n", LinodeProviderName, ipInfo.IPPrefix, ipInfo.Region)
...
func NewLinodeProvider(output string) *LinodeProvider {
